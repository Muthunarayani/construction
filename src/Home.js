...
<button class='bg-yellow-300 px-10 py-5 text-xl uppercase tracking-widest mr-10 text-white font-bold'>read more</button>
</div> 
</div> 
</div>
<br></br>
...
<p className='text-3xl text-center text-yellow-300 font-bold pt-8'>SPECIAL OFFERS</p>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-5.25h5.25M7.5 15h3M3.375 5.25c-.621 0-1.125.504-1.125 1.125v3.026a2.999 2.999 0 010 5.198v3.026c0 .621.504 1.125 1.125 1.125h17.25c.621 0 1.125-.504 1.125-1.125v-3.026a2.999 2.999 0 010-5.198V6.375c0-.621-.504-1.125-1.125-1.125H3.375z" />
          ...
          <div>
          <p class="mb-3 text-gray-500 dark:text-gray-400 mt-1 ml-8 text-justify">Track work across the enterprise through an open, collaborative platform. Link issues across Jira and ingest data from other software development tools, so your IT support and operations teams have richer contextual information to rapidly respond to requests, incidents, and changes.</p>
          </div>
          </div>
          </div>
          </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />
   ...
   <div class="grid grid-cols-1 gap-6 sm:grid-cols-3 pt-5">
            <div class="max-w-sm rounded overflow-hidden shadow-lg mx-auto mt-10">
      <div className="w-full p-8 text-center">
        <div className="flex ">
                <div>
